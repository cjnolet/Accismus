...
public class Admin {
  ...
  public static void initialize(Properties props) throws AlreadyInitializedException {
    try {
      ...
      if (props.getProperty(InitializationProperties.CLASSPATH_PROP) != null) {
        // TODO add org.fluo version to context name to make it unique
  ...
  static void addObserver(Map<Column,ObserverConfiguration> observers, Map.Entry<Object,Object> entry) {
